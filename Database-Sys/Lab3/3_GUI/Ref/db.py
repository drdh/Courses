...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        btn_ac_adduser = QAction( "Add", self)
        ...
        btn_ac_search = QAction( "Search", self)
        ...
        adduser_action = QAction("Insert", self)
        adduser_action.triggered.connect(self.insert)
        file_menu.addAction(adduser_action)

        searchuser_action = QAction( "Search", self)
        searchuser_action.triggered.connect(self.search)
        file_menu.addAction(searchuser_action)

        deluser_action = QAction( "Delete", self)
...
passdlg = LoginDialog()
if(passdlg.exec_() == 2): #QDialog.Accepted
    window = MainWindow()
    window.show()
    window.loaddata()
sys.exit(app.exec_())