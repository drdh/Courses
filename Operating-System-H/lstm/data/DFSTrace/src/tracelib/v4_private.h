...
static char *rcsid = "$Header: /home/cvs/root/DFSTrace/src/tracelib/v4_private.h,v 1.1.1.1 1998/09/29 18:39:19 tmkr Exp $";
#endif _BLURB_


/* 
 * v4_private.h -- Information specific to Version 3 traces.
 */

#ifndef _V4_PRIVATE_H_
#define _V4_PRIVATE_H_

#include <sys/types.h>
#include <sys/time.h>

#define V4_START   684129600   /* 9/6/91 00:00 in seconds */
#define V4_END     946530000   /* 12/30/99 00:00 in seconds */

#define DFS_TRACE_CHUNK_SIZE_V4 4096

#define DFS_MAXSYSCALL_V4  0x1e
#define DFS_MAXOPCODE_V4   0x23

#define KERNELVERSIONMAX_V4     1      /* kernel minor version */
#define AGENTVERSIONMAX_V4      1      /* agent minor version */
#define COLLECTORVERSIONMAX_V4  4      /* collector minor version */

/* 
 * trace file preamble -- written by collection server. 
 * Data fields in network order.
 */
typedef struct dfs_file_preamble_v4 {
	u_int   hostAddress;
