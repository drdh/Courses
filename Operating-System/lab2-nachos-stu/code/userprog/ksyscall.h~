...
void forked(int arg)
{
  { //begin: 实验二的代码请写在这里++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    kernel->machine->WriteRegister(2, arg);
    kernel->machine->PCplusPlus();
    kernel->machine->Run();
    //kernel->currentThread->Yield();
    //test
    kernel->currentThread->Finish();
    //kernel->currentThread->parent->joinSemMap_getSemByID(arg)->V();
   // sema->V();
  } //end: ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
}
