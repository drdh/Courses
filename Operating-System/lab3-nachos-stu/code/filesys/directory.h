...
class Directory {
  public:
    ...
    int Find(char *name, bool justCompareName = FALSE);		// Find the sector number of the 
  ...
  private:
    ...
    int FindIndex(char *name, bool justCompareName = FALSE);		// Find the index into the directory 
